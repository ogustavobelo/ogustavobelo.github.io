        ...
        source: (query, callback) => {
          ...
          if (searchConfig.type === 'lunr') {
            const search = () => {
              ...
              this._index.search(query).forEach(({
                ref,
                matchData: {
                  metadata
                }
        ...
        templates: {
          ...
          footer: ({}) => {
            const {
              ...
              searchLabel: searchConfig.searchBy,
              searchName: 'Algolia',
            ...
            return `<div class="search-footer">${searchLabel} <a href="${href}" rel="noopener noreferrer" target="_blank">${icon} ${searchName}</a></div>`;
          }
        }
      });
